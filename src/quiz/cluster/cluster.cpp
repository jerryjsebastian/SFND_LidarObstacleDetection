...
pcl::visualization::PCLVisualizer::Ptr initScene(Box window, int zoom)
{
	...
	viewer->setBackgroundColor (0, 0, 0);
  	...
  	viewer->addCube(window.x_min, window.x_max, window.y_min, window.y_max, 0, 0, 0.5, 0.5, 0.5, "window");
  	return viewer;
}
...
void proximity(int pointIdx, const std::vector<std::vector<float>>& points, std::vector<int>& cluster, std::vector<bool>& processed, KdTree* tree, float distanceTol) 
{
